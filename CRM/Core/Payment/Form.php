...
class CRM_Core_Payment_Form {
  ...
  static function setCreditCardFields(&$form) {
    ...
    $form->_paymentFields['credit_card_number'] = array(
      ...
      'cc_field' => TRUE,
      'attributes' => array('size' => 20, 'maxlength' => 20, 'autocomplete' => 'off', 'placeholder' => 'Card Number'),
      'is_required' => TRUE,
    );

    $form->_paymentFields['cardholder_name'] = array(
      'htmlType' => 'text',
      'name' => 'cardholder_name',
      'title' => ts('Card Holder Name'),
      'cc_field' => TRUE,
      'attributes' => array('size' => 20, 'maxlength' => 20, 'autocomplete' => 'off', 'placeholder' => 'Card Holder Name'),
      'is_required' => TRUE,
    );
    ...
    $form->_paymentFields['cvv2'] = array(
      ...
      'cc_field' => TRUE,
      'attributes' => array('size' => 5, 'maxlength' => 10, 'autocomplete' => 'off', 'placeholder' => 'CVV'),
